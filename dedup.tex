...
\begin{figure*}[!t]
\centerline{
\subfloat[Exchange]{\includegraphics[width=2.5in]{figure/dedup/full011}
\label{ex}}
\hfil
\subfloat[Exchange\_is]{\includegraphics[width=2.5in]{figure/dedup/full012}
\label{ei}}
\hfil
\subfloat[Exchange\_mb]{\includegraphics[width=2.5in]{figure/dedup/full013}
\label{em}}}
\centerline{\subfloat[fredp4]{\includegraphics[width=2.5in]{figure/dedup/full014}
\label{fp}}
\hfil
\subfloat[fredvar]{\includegraphics[width=2.5in]{figure/dedup/full015}
\label{fv}}
\hfil
\subfloat[workstation]{\includegraphics[width=2.5in]{figure/dedup/full016}
\label{ws}}
}
...
\begin{figure*}[!t]
\centerline{
\subfloat[Base segments]{\includegraphics[width=2.5in]{figure/dedup/full005}
\label{bs}}
\hfil
\subfloat[Duplicate segments]{\includegraphics[width=2.5in]{figure/dedup/full002}
\label{ds}}
\hfil
\subfloat[Average references]{\includegraphics[width=2.5in]{figure/dedup/full009}
\label{ar}}}
...
Numerous works have also been applied in filesystem activities and its contents~\cite{douceur:1999, leung:2008, douceur:1999} with one paper using a simple statistical analysis to characterize a filesystem impression~\cite{agrawal:2009}. While these approaches all reveal some interesting intuitions of how we use storage systems, the scope is too generic to be neither accurate or simple enough to be applied in real systems. More specific workload analysis have been targeted to SSDs~\cite{soundararajan:2010} and we use some of their approach in out analysis. 
 ...
 \begin{figure}[!t]
\centerline{
\subfloat[Real Data]{\includegraphics[width=1.9in]{figure/dedup/full016}
\label{wo}}
\hfil
\subfloat[Predicted Data]{\includegraphics[width=1.9in]{figure/dedup/prediction001}
\label{wp}}
}
