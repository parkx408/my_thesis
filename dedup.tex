...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{queue}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{seg_classification.jpg}
...
\begin{figure*}[!t]
\centerline{
\subfloat[Exchange]{\includegraphics[width=2.5in]{full011}
\label{ex}}
\hfil
\subfloat[Exchange\_is]{\includegraphics[width=2.5in]{full012}
\label{ei}}
\hfil
\subfloat[Exchange\_mb]{\includegraphics[width=2.5in]{full013}
\label{em}}}
\centerline{\subfloat[fredp4]{\includegraphics[width=2.5in]{full014}
\label{fp}}
\hfil
\subfloat[fredvar]{\includegraphics[width=2.5in]{full015}
\label{fv}}
\hfil
\subfloat[workstation]{\includegraphics[width=2.5in]{full016}
\label{ws}}
}
...
\begin{figure*}[!t]
\centerline{
\subfloat[Base segments]{\includegraphics[width=2.5in]{full005}
\label{bs}}
\hfil
\subfloat[Duplicate segments]{\includegraphics[width=2.5in]{full002}
\label{ds}}
\hfil
\subfloat[Average references]{\includegraphics[width=2.5in]{full009}
\label{ar}}}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{full018}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{full019}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{disk_q}
...
Numerous works have also been applied in filesystem activities and its contents\cite{douceur1999large, Leung:2008:MAL:1404014.1404030, Douceur:1999:LSF:301464.301480} with one paper using a simple statistical analysis to characterize a filesystem impression\cite{ Agrawal:2009:GRI:1629080.1629086}. While these approaches all reveal some interesting intuitions of how we use storage systems, the scope is too generic to be neither accurate or simple enough to be applied in real systems. More specific workload analysis have been targeted to SSDs\cite{ soundararajan2010extending} and we use some of their approach in out analysis. 
 ...
 \begin{figure}[!t]
\centerline{
\subfloat[Real Data]{\includegraphics[width=1.9in]{full016}
\label{wo}}
\hfil
\subfloat[Predicted Data]{\includegraphics[width=1.9in]{prediction001}
\label{wp}}
}
