...
\begin{figure}[!t]
\centering
\subfloat[Initial data stores latencies.]{\label{lb_init}\includegraphics[width=0.3\textwidth]{figure/initial_datastore_latency.pdf}}
\subfloat[Result of Basil load balancing]{\label{lb_basil}\includegraphics[width=0.3\textwidth]{figure/basil_datastore_latency.pdf}}
\subfloat[Result of Romano load balancing.]{\label{lb_after}\includegraphics[width=.3\textwidth]{figure/romano_datastore_latency.pdf}}
