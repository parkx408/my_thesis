\begin{tikzpicture}[auto,node distance=2cm]
    ...
    \node [ellip, left of=init, node distance=6cm] (manual) {Benchmark Manual};
    \node [block, below of=init] (lvl) {Parameter Level Decision};
    \node [block, below of=manual] (PB) {PB Experiment Generation};
    \node [ellip, below of=lvl] (p_list) {Parameter List};
    \node [ellip, below of=PB] (PB_table) {PB Table};
    ...
    \node [ellip, below of=run](result){Results};
